...
export function Schedule() {
  ...
  return (
    <div className='Schedule' onClick={openPopup}>
      ...
      <Popup closeOnEscape={!childIsOpen} open={popupOpen} onClose={closeModal} modal closeOnDocumentClick={false}>
        <PopUp_ScheduleRuleEdit OnChildOpenChanged={setChildIsOpen} /> 
      </Popup>
    </div>
  );
}
